...
trait StatusAttribute
{
    ...
    {
        return '<a href="' .
            route('admin.status.destroy', $this) .
            '"
			 data-method="delete"
    ...
    {
        return '<div
       class="btn-group btn-group-sm" status="group" aria-label="Status Actions">
	   		 ' .
            $this->view_button .
            '
			  ' .
