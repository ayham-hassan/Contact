...
trait AddressAttribute
{
    ...
    {
        return '<a href="' .
            route('admin.address.destroy', $this) .
            '"
			 data-method="delete"
     ...
     * @return  string
     */
    public function getCustomersButtonAttribute()
    {
        return '<a href="' .
            route('admin.customer.address', $this) .
            ' " class="dropdown-item">' .
            __('Customers') .
            '</a> ';
    }
    ...
    {
        return '<div
       class="btn-group btn-group-sm" address="group" aria-label="Address Actions">
	   		 ' .
            $this->view_button .
            '
			  ' .
