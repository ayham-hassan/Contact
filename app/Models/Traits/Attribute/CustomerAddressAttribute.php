...
/**
 * Trait CustomerAddressAttribute.
 */
trait CustomerAddressAttribute
{
    /**
    ...
    {
        return '<a href="' .
            route('admin.customer_address.show', $this) .
    ...
    /**
     * @return string  customer_address
     */
    public function getEditButtonAttribute()
    {
        return '<a href="' .
            route('admin.customer_address.edit', $this) .
            '" data-toggle="tooltip" data-placement="top" title="' .
    ...
    {
        return '<a href="' .
            route('admin.customer_address.destroy', $this) .
            '"
			 data-method="delete"
    ...
    {
        return '<div
       class="btn-group btn-group-sm" customer_address="group" aria-label="CustomerAddress Actions">
	   		 ' .
            $this->view_button .
            '
			  ' .
