...
trait ContactActivityAttribute
{
    ...
    {
        return '<a href="' .
            route('admin.contact_activity.show', $this) .
    ...
    /**
     * @return string  contact_activity
     */
    public function getEditButtonAttribute()
    {
        return '<a href="' .
            route('admin.contact_activity.edit', $this) .
            '" data-toggle="tooltip" data-placement="top" title="' .
    ...
    {
        return '<a href="' .
            route('admin.contact_activity.destroy', $this) .
            '"
			 data-method="delete"
    ...
    {
        return '<div
       class="btn-group btn-group-sm" contact_activity="group" aria-label="ContactActivity Actions">
	   		 ' .
            $this->view_button .
            '
			  ' .
