...
trait OutcomeAttribute
{
    ...
    {
        return '<a href="' .
            route('admin.outcome.destroy', $this) .
            '"
			 data-method="delete"
    ...
    {
        return '<div
       class="btn-group btn-group-sm" outcome="group" aria-label="Outcome Actions">
	   		 ' .
            $this->view_button .
            '
			  ' .
